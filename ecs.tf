...
resource "aws_cloudwatch_log_group" "log_group" {
  ...
  lifecycle {
    create_before_destroy = true #This will ensure the log group is created b4 deleting any existing one.
  }
}
  ...
  container_definitions = jsonencode([
    {
      ...
      environmentFiles = [
        {
          value = "arn:aws:s3:::${var.project_name}-${var.env_file_bucket_name}/${var.env_file_name}" #arn of env file
          type  = "s3"
        }
      ]
